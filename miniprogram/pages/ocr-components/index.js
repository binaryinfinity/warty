...
Page({
    ...
    idback_success(e) {
        this.setData({
            'id.authority': e.detail.authority.text,
            'id.valid_date': e.detail.valid_date.text,
        })
    },

    id_enable() {
        this.setData({
            'id.disabled': !this.data.id.disabled
        })
    },
    ...
    platenum_success(e) {
        this.setData({
            plate_num: e.detail.number.text
        })
    },

    bankcard_success(e) {
        this.setData({
            bankcard_id: e.detail.number.text
        })
    },
